...
function createOrder() {
	...
	request
		.post('/system/order/create-normal', {
			...order,
							...
							<div class="checkout-order-area">
								...
								<ul class="order-list-check mb-5">
									<li class="order-list-header">
										...
										<span class="heading-title-pro">合计</span>
									</li>
									<li
										class="order-list-info-pro"
								...
								<div class="post-btn-area">
									<button
										type="submit"
										class="auth-btn post" @click="createOrder">
										确认订单
									</button>
								</div>
							</div>
